...
/**
 * Project Comparison Tool UI
 * Issue #1416: Side-by-side project comparison
 */
...
export function ProjectComparisonTool({ initialProjectIds = [] }: ProjectComparisonToolProps) {
  ...
  // Load comparison projects when selection changes
  useEffect(() => {
