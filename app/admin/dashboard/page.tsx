...
export default async function AdminDashboardPage({
  ...
  const selectedStatus =
    resolvedSearchParams.status && TREE_STATUSES.includes(resolvedSearchParams.status)
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section aria-label="overview-heading" className="mb-8 space-y-4">
          ...
          <CardHeader>
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <CardDescription>
                  Latest platform actions in chronological order.
                </CardDescription>
              </div>
              ...
              <form method="get" className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="rounded-md border border-border bg-background px-3 py-1 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-stellar-blue"
                >
                ...
                <button
                  type="submit"
                  className="rounded-md bg-stellar-blue px-3 py-1 text-sm font-medium text-white transition-colors hover:bg-stellar-blue/90 focus:outline-none focus:ring-2 focus:ring-stellar-blue"
                >
                  Apply
                </button>
              </form>
