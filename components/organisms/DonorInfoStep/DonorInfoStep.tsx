          ...
          {isAnonymousMode ? (
            <div className="space-y-6">
              <div className="p-6 rounded-xl bg-purple-50 border border-purple-200 text-center space-y-3">
                <UserX className="w-12 h-12 text-purple-500 mx-auto" />
                <Text className="font-semibold text-purple-800">Anonymous Donation Selected</Text>
                <Text variant="muted" className="text-sm text-purple-600">
                  Your identity will be protected using zero-knowledge proofs on the Stellar
                  blockchain. No personal information will be stored.
                </Text>
              </div>
              <Button
                type="button"
